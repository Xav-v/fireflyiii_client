...
from fireflyiii_client.paths.api_v1_rules_id_test import get  # noqa: E501
from fireflyiii_client import configuration, schemas, api_client

from .. import ApiTestMixin


class TestApiV1RulesIdTest(ApiTestMixin, unittest.TestCase):
    """
    ApiV1RulesIdTest unit test stubs

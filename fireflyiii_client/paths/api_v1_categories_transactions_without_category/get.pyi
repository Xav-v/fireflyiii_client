...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_transaction_without_category_oapg(
        self,
...
class ListTransactionWithoutCategory(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_transaction_without_category(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def list_transaction_without_category(
        ...
        return self._list_transaction_without_category_oapg(

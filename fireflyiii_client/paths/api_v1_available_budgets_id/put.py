...
from fireflyiii_client import api_client, exceptions
...
# body param
SchemaForRequestBodyApplicationVndApijson = AvailableBudgetUpdate
SchemaForRequestBodyApplicationXWwwFormUrlencoded = AvailableBudgetUpdate


request_body_available_budget_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_available_budget_oapg(
        self,
    ...
    def _update_available_budget_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_available_budget_update.serialize(body, content_type)
...
class UpdateAvailableBudget(BaseApi):
    ...
    def update_available_budget(
        ...
        return self._update_available_budget_oapg(
            body=body,

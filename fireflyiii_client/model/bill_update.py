...
class BillUpdate(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["currency_id", "currency_code", "name", "amount_min", "amount_max", "date", "end_date", "extension_date", "repeat_freq", "skip", "active", "notes", "object_group_id", "object_group_title", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["currency_id", "currency_code", "name", "amount_min", "amount_max", "date", "end_date", "extension_date", "repeat_freq", "skip", "active", "notes", "object_group_id", "object_group_title", ], str]):

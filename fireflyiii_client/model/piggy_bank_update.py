...
class PiggyBankUpdate(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "account_id", "currency_id", "currency_code", "target_amount", "current_amount", "start_date", "target_date", "order", "active", "notes", "object_group_id", "object_group_title", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "account_id", "currency_id", "currency_code", "target_amount", "current_amount", "start_date", "target_date", "order", "active", "notes", "object_group_id", "object_group_title", ], str]):

...
class WebhookMessage(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["created_at", "updated_at", "sent", "errored", "webhook_id", "uuid", "string", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["created_at", "updated_at", "sent", "errored", "webhook_id", "uuid", "string", ], str]):

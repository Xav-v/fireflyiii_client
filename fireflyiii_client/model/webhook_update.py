...
class WebhookUpdate(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["active", "title", "secret", "trigger", "response", "delivery", "url", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["active", "title", "secret", "trigger", "response", "delivery", "url", ], str]):

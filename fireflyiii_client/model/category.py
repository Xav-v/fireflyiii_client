...
class Category(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "created_at", "updated_at", "notes", "spent", "earned", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "created_at", "updated_at", "notes", "spent", "earned", ], str]):

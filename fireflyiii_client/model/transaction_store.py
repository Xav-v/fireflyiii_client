...
class TransactionStore(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["transactions", "error_if_duplicate_hash", "apply_rules", "fire_webhooks", "group_title", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["transactions", "error_if_duplicate_hash", "apply_rules", "fire_webhooks", "group_title", ], str]):

...
class Bill(
            ...
            class paid_dates(
                ...
                class MetaOapg:
                    ...
                    class items(
                        ...
                        def __getitem__(self, name: typing.Union[typing_extensions.Literal["transaction_group_id", "transaction_journal_id", "date", ], str]):
                        ...
                        def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["transaction_group_id", "transaction_journal_id", "date", ], str]):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "amount_min", "amount_max", "date", "repeat_freq", "created_at", "updated_at", "currency_id", "currency_code", "currency_symbol", "currency_decimal_places", "end_date", "extension_date", "skip", "active", "order", "notes", "next_expected_match", "next_expected_match_diff", "object_group_id", "object_group_order", "object_group_title", "pay_dates", "paid_dates", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)

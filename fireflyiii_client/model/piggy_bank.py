...
class PiggyBank(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["account_id", "name", "target_amount", "created_at", "updated_at", "account_name", "currency_id", "currency_code", "currency_symbol", "currency_decimal_places", "percentage", "current_amount", "left_to_save", "save_per_month", "start_date", "target_date", "order", "active", "notes", "object_group_id", "object_group_order", "object_group_title", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        target_date: typing.Union[MetaOapg.properties.target_date, None, str, datetime, schemas.Unset] = schemas.unset,

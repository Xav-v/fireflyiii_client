...
class PiggyBankEvent(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["created_at", "updated_at", "currency_id", "currency_code", "currency_symbol", "currency_decimal_places", "amount", "transaction_journal_id", "transaction_group_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["created_at", "updated_at", "currency_id", "currency_code", "currency_symbol", "currency_decimal_places", "amount", "transaction_journal_id", "transaction_group_id", ], str]):

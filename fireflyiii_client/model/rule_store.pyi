...
class RuleStore(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["title", "rule_group_id", "trigger", "triggers", "actions", "description", "rule_group_title", "order", "active", "strict", "stop_processing", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["title", "rule_group_id", "trigger", "triggers", "actions", "description", "rule_group_title", "order", "active", "strict", "stop_processing", ], str]):

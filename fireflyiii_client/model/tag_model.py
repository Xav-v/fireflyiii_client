...
class TagModel(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["tag", "created_at", "updated_at", "date", "description", "latitude", "longitude", "zoom_level", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["tag", "created_at", "updated_at", "date", "description", "latitude", "longitude", "zoom_level", ], str]):

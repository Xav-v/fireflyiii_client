...
class TransactionLink(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["link_type_id", "inward_id", "outward_id", "created_at", "updated_at", "link_type_name", "notes", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["link_type_id", "inward_id", "outward_id", "created_at", "updated_at", "link_type_name", "notes", ], str]):

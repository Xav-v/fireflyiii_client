...
class RuleAction(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["type", "value", "id", "created_at", "updated_at", "order", "active", "stop_processing", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["type", "value", "id", "created_at", "updated_at", "order", "active", "stop_processing", ], str]):

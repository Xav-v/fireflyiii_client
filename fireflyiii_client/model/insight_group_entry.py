...
class InsightGroupEntry(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "difference", "difference_float", "currency_id", "currency_code", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "difference", "difference_float", "currency_id", "currency_code", ], str]):

...
class RuleUpdate(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["title", "description", "rule_group_id", "order", "trigger", "active", "strict", "stop_processing", "triggers", "actions", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["title", "description", "rule_group_id", "order", "trigger", "active", "strict", "stop_processing", "triggers", "actions", ], str]):

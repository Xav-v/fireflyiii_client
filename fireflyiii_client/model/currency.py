...
class Currency(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["code", "name", "symbol", "created_at", "updated_at", "enabled", "default", "decimal_places", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["code", "name", "symbol", "created_at", "updated_at", "enabled", "default", "decimal_places", ], str]):

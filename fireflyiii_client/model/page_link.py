...
class PageLink(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["self", "first", "last", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["self", "first", "last", ], str]):

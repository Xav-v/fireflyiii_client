...
class WebhookStore(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["title", "trigger", "response", "delivery", "url", "active", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["title", "trigger", "response", "delivery", "url", "active", ], str]):

...
class CurrencyStore(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["code", "name", "symbol", "enabled", "default", "decimal_places", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["code", "name", "symbol", "enabled", "default", "decimal_places", ], str]):

...
class RuleGroup(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["title", "created_at", "updated_at", "description", "order", "active", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["title", "created_at", "updated_at", "description", "order", "active", ], str]):

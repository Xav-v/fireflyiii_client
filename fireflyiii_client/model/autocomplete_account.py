...
class AutocompleteAccount(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "name_with_balance", "type", "currency_id", "currency_name", "currency_code", "currency_symbol", "currency_decimal_places", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "name_with_balance", "type", "currency_id", "currency_name", "currency_code", "currency_symbol", "currency_decimal_places", ], str]):

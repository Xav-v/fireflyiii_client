...
class ObjectGroup(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["title", "order", "created_at", "updated_at", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["title", "order", "created_at", "updated_at", ], str]):

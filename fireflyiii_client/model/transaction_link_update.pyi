...
class TransactionLinkUpdate(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["link_type_id", "link_type_name", "inward_id", "outward_id", "notes", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["link_type_id", "link_type_name", "inward_id", "outward_id", "notes", ], str]):

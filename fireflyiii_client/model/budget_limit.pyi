...
class BudgetLimit(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["start", "end", "budget_id", "amount", "created_at", "updated_at", "currency_id", "currency_code", "currency_name", "currency_symbol", "currency_decimal_places", "period", "spent", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["start", "end", "budget_id", "amount", "created_at", "updated_at", "currency_id", "currency_code", "currency_name", "currency_symbol", "currency_decimal_places", "period", "spent", ], str]):

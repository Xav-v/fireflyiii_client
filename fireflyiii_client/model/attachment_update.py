...
class AttachmentUpdate(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["filename", "title", "notes", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["filename", "title", "notes", ], str]):

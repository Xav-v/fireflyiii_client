...
class LinkType(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "inward", "outward", "editable", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "inward", "outward", "editable", ], str]):

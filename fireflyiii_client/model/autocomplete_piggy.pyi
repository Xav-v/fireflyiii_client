...
class AutocompletePiggy(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "currency_id", "currency_code", "currency_symbol", "currency_name", "currency_decimal_places", "object_group_id", "object_group_title", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "currency_id", "currency_code", "currency_symbol", "currency_name", "currency_decimal_places", "object_group_id", "object_group_title", ], str]):

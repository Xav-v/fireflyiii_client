...
class BudgetSpent(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["sum", "currency_id", "currency_code", "currency_symbol", "currency_decimal_places", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["sum", "currency_id", "currency_code", "currency_symbol", "currency_decimal_places", ], str]):

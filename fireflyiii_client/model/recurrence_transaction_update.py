...
class RecurrenceTransactionUpdate(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["description", "amount", "foreign_amount", "currency_id", "currency_code", "foreign_currency_id", "budget_id", "category_id", "source_id", "destination_id", "tags", "piggy_bank_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["description", "amount", "foreign_amount", "currency_id", "currency_code", "foreign_currency_id", "budget_id", "category_id", "source_id", "destination_id", "tags", "piggy_bank_id", ], str]):

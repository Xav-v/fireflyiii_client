...
class BillStore(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "amount_min", "amount_max", "date", "repeat_freq", "currency_id", "currency_code", "end_date", "extension_date", "skip", "active", "notes", "object_group_id", "object_group_title", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "amount_min", "amount_max", "date", "repeat_freq", "currency_id", "currency_code", "end_date", "extension_date", "skip", "active", "notes", "object_group_id", "object_group_title", ], str]):

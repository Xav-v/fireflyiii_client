# fireflyiii_client.model.tag_model.TagModel
...
**date** | None, str, datetime,  | NoneClass, str,  | The date to which the tag is applicable. | [optional] value must conform to RFC-3339 date-time

<a name="__pageTop"></a>
# fireflyiii_client.apis.tags.categories_api.CategoriesApi

All URIs are relative to *https://demo.firefly-iii.org*

Method | HTTP request | Description
------------- | ------------- | -------------
[**delete_category**](#delete_category) | **delete** /api/v1/categories/{id} | Delete a category.
[**get_category**](#get_category) | **get** /api/v1/categories/{id} | Get a single category.
[**list_attachment_by_category**](#list_attachment_by_category) | **get** /api/v1/categories/{id}/attachments | Lists all attachments.
[**list_category**](#list_category) | **get** /api/v1/categories | List all categories.
[**list_transaction_by_category**](#list_transaction_by_category) | **get** /api/v1/categories/{id}/transactions | List all transactions in a category.
[**list_transaction_without_category**](#list_transaction_without_category) | **get** /api/v1/categories/transactions-without-category | All transactions without a category.
[**store_category**](#store_category) | **post** /api/v1/categories | Store a new category
[**update_category**](#update_category) | **put** /api/v1/categories/{id} | Update existing category.
...
from fireflyiii_client.apis.tags import categories_api
...
404 | [ApiResponseFor404](#delete_category.ApiResponseFor404) | No such category.
...
404 | [ApiResponseFor404](#get_category.ApiResponseFor404) | Category not found
...
<a name="list_attachment_by_category"></a>
...
404 | [ApiResponseFor404](#list_attachment_by_category.ApiResponseFor404) | No such category.
...
<a name="list_transaction_by_category"></a>
...
<a name="list_transaction_without_category"></a>
...
with fireflyiii_client.ApiClient(configuration) as api_client:
    ...
    try:
        # All transactions without a category.
        api_response = api_instance.list_transaction_without_category(
            query_params=query_params,
        )
        pprint(api_response)
    except fireflyiii_client.ApiException as e:
...
------------- | ------------- | -------------
n/a | api_client.ApiResponseWithoutDeserialization | When skip_deserialization is True this response is returned
200 | [ApiResponseFor200](#list_transaction_without_category.ApiResponseFor200) | A list of transactions.

#### list_transaction_without_category.ApiResponseFor200
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | typing.Union[SchemaFor200ResponseBodyApplicationVndApijson, ] |  |
...
422 | [ApiResponseFor422](#store_category.ApiResponseFor422) | Validation errors (see body)
...
422 | [ApiResponseFor422](#update_category.ApiResponseFor422) | Validation errors (see body)
